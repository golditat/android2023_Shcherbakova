...
public final class ItemDateBinding implements ViewBinding {
  ...
  @NonNull
  public final TextView dateTw;

  private ItemDateBinding(@NonNull ConstraintLayout rootView, @NonNull TextView dateTw) {
  ...
  public static ItemDateBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.date_tw;
      TextView dateTw = ViewBindings.findChildViewById(rootView, id);
      if (dateTw == null) {
        break missingId;
      }

      return new ItemDateBinding((ConstraintLayout) rootView, dateTw);
    }
